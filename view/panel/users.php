...
<a onclick="return confirm('Вы уверены что хотите удалить?')" href="/users/delete/<? echo $log['id']; ?>" data-toggle="tooltip" title="Удалить" class="btn btn-danger-outline btn-xs"><i class="fa fa-trash"></i></a>
</td>
</tr>
<? } ?>
</tbody>
